...
class TestConfiguration(TestCase):
    ...
    def test_defaults(self):
        ...
        self.assertEqual(conf.get('Logging', 'file'), conf.greaseDir + conf.fs_sep + 'log' + conf.fs_sep + 'grease.log')
        self.assertEqual(conf.get('Configuration', 'mode'), 'filesystem')
        self.assertEqual(conf.get('Configuration', 'dir'), conf.greaseDir + conf.fs_sep + 'etc')
        self.assertEqual(conf.get('Sourcing', 'mode'), 'filesystem')
        self.assertEqual(conf.get('Sourcing', 'dir'), conf.greaseDir + conf.fs_sep + 'etc')
